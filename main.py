...
#You can change to specific model for this
def make_predictions(input_df, input_dict):
  ...
  #displays the gauge char
  with col1:
    fig = ut.create_gauge_chart(avg_probability)
    st.plotly_chart(fig, use_container_width=True)
    st.write(f"The customer has a {avg_probability: .2%} probability of churning.")
  #displays the model probability chart
  with col2:
    fig_probs = ut.create_model_probability_chart(probabilities)
    st.plotly_chart(fig_probs, use_container_width=True)

  
  #displays models probabilities on the front end
  #comment it out ---------
  
  # st.markdown("### Model Probabilitie")
...
def explain_prediction (probability, input_dict, surname):
  ...
  DO NOT MENTION TENURE on the response
  ...
  Do not mention the age of the customer and their balance on the response. Also do not mention the features in the response in any way. DO NOT MENTION CREDIT SCORE as well. Do not mention their salary as well in any way. dont mention tenure on the response. 
  """
...
def generate_email(probability, input_dict, explanation, surname):
  prompt = f""" Your are a manager at HS Bank. You are responsible for ensuring customers stay with the bank and are incentivized with verious offers. 
...
#------end of funciton Generate email 
...
if selected_customer_option:
  ...
  #calls two functions we just defined
